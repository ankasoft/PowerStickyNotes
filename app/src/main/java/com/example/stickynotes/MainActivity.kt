...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateTimerUI() {
        ...
        // İlerleme yüzdesini hesapla ve ProgressBar'ı güncelle
    ...
    private fun showEditDialog(note: Note?) {
        val dialogView = layoutInflater.inflate(
            com.example.stickynotes.R.layout.dialog_edit_note,
            null
        )
        val editText = dialogView.findViewById<EditText>(
            com.example.stickynotes.R.id.editNoteText
        )
        ...
        dialogView.findViewById<android.widget.Button>(
            com.example.stickynotes.R.id.btnCancel
        ).setOnClickListener {
            dialog.dismiss()
        }

        dialogView.findViewById<android.widget.Button>(
            com.example.stickynotes.R.id.btnSave
        ).setOnClickListener {
